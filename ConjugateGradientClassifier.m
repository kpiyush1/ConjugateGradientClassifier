...
ConjugateGradientClassifier::usage =
        "ConjugateGradientCalssifier is a parameter learning algorithm for linear and logistic regression
        using conjugate gradient optimization. Only works for numerical data"
...
(* Main function for learning parameters for classification and regression. The arguments for the function are: 
	a) training data b) costfunction, c) costfunction gradient, d) initial parameter (theta), 
		e) hyperparameter values (lambda) *)
